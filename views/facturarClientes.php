                    ...
                    <?php if (isset($_GET["idPedido"]) && (!isset($_GET["c"]) || (isset($_GET["c"]) && $_GET["c"] < 2))): ?>
                        <form action="../controllers/controllerPedidos.php" method="post">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">Ingrese la cantidad de clientes</span>
                                <input type="number" class="form-control text-center" required min=2 value="2" name="cantidadClientes">
                                <input type="submit" class="btn btn-secondary" value="Calcular Valores">
                            </div>
                        </form>
                    <?php endif; ?>
                            ...
                            ?>
                                    <div class="row mb-3">
                                        <div class="col-sm-6 col-md-6 col-lg-3 mb-1">
                                            ...
                                            <input type="text" class="form-control" id="nombreClienteProcesarSeparado_<?php echo $i; ?>" name="nombreClienteProcesarSeparado_<?php echo $i; ?>" required value="<?php echo isset($pedido['nombre_cliente']) && !empty($pedido['nombre_cliente']) ? $pedido['nombre_cliente'] : ''; ?>" placeholder="Nombre...">
                                        </div>
                                        <div class="col-sm-6 col-md-6 col-lg-3 mb-1">
                                            <label for="telefonoProcesarSeparado_<?php echo $i; ?>" class="form-label">Teléfono del Cliente</label>
                                            <input type="tel" class="form-control" id="telefonoProcesarSeparado_<?php echo $i; ?>" name="telefonoProcesarSeparado_<?php echo $i; ?>" required value="<?php echo isset($pedido['telefono_cliente']) && !empty($pedido['telefono_cliente']) ? $pedido['telefono_cliente'] : ''; ?>">
                                        </div>

                                        <div class="col-sm-6 col-md-6 col-lg-2 mb-1">
                                            <label for="mesaOrdenProcesarSeparado_<?php echo $i; ?>" class="form-label">Mesa</label>
                                            <input type="number" class="form-control" id="mesaOrdenProcesarSeparado_<?php echo $i; ?>" name="mesaOrdenProcesarSeparado_<?php echo $i; ?>" placeholder="Número de mesa..." min="1" max="10" value="<?php echo $pedido['mesa']; ?>" readonly>
                                        </div>
                                        <div class="col-sm-6 col-md-6 col-lg-2 mb-1">
                                            <label for="servicioOrdenProcesarSeparado_<?php echo $i; ?>" class="form-label">Servicio</label>
                                            <select class="form-select" id="servicioOrdenProcesarSeparado_<?php echo $i; ?>" name="servicioOrdenProcesarSeparado_<?php echo $i; ?>" disabled>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-2 mb-1">
                                            ...
                                            <select class="form-select" id="metodoPago_<?php echo $i; ?>" name="metodoPago_<?php echo $i; ?>" required>
